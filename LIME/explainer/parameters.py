...
date = '20200831' # Only used in plotting
...
num_feat_rem = ['product_qty', 'product_price', 'visit_duration', 'visit_nb_pages', 'visit_unique_pages',
                'Latitude', 'Longitude', 'product_rating', 'product_number_of_ratings', 'Delta_time'] # Only used in
# plotting

cat_feat_names = ['product_department', 'product_category', 'product_sub_category'] # Only used in plotting
...
label_category = {'week_day': ['PAD', 'Sunday', 'Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday'],
                  ...
                  'event_env': ['PAD', 'None_event', 'product_page', 'purchase', 'add_to_cart', 'event_Na_0',
